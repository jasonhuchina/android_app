...
git lfs install
git lfs track *
git remote add origin https://gitlab.com/jasonhu.mail.g/android_app
git config lfs.https://gitlab.com/jasonhu.mail.g/android_app.git/info/lfs.locksverify false
